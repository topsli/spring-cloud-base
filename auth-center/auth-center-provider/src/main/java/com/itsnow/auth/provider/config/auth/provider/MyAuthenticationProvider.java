package com.itsnow.auth.provider.config.auth.provider;

import com.itsnow.auth.provider.config.auth.filter.MyLoginAuthenticationFilter;
import com.itsnow.auth.provider.config.auth.token.MyAuthenticationToken;
...
/**
 * Created by Xuekun_Li on 2018/6/16.
 * 自定义密码验证
