package com.itsnow.auth.provider.config.auth;


import com.itsnow.auth.provider.config.auth.filter.MyLoginAuthenticationFilter;
import com.itsnow.auth.provider.config.auth.handler.MyLoginAuthSuccessHandler;
import com.itsnow.auth.provider.config.auth.provider.MyAuthenticationProvider;
import com.itsnow.auth.provider.service.BaseUserDetailService;
...
/**
 * Created by Xuekun_Li on 2018/4/15.
 */
@Configuration
